export const translations = {
  en: {
    ...
    // TaskForm specific translations
    assignees: "Assignees",
    addAssignee: "Add Assignee",
    selectMemberToAdd: "Select member to add",
    allMembersAssigned: "All members have been assigned",
    assignmentInfo: "Assignment Information",
    selectAtLeastOneAssignee: "Please select at least one assignee",
    singleAssigneeSelected: "One assignee selected",
    multipleAssigneesSelected: "{count} assignees selected",
    clearAll: "Clear All",
    ...
    addRemoveMembers: "Add or remove members",
    groupSettings: "Group Settings",
    customizeGroup: "Customize group preferences",
    leaveGroup: "Leave Group",
    leaveGroupWarning: "You will no longer receive group messages",
    sendMessage: "Send Message",
    inviteMembers: "Invite Members",
    groupDescription: "Group description not available",
    ...
    teamsLed: "Teams Led",
    readyToBoostTeamProductivity: "Ready to Boost Team Productivity", 

    // Account Manager specific translations
    accountManagerDashboard: "Account Manager Dashboard",
    adminDashboard: "Admin Dashboard",
    teamPerformanceOverview: "Team Performance Overview",
    manageTeamTasks: "Manage Team Tasks",
    manageAllTasks: "Manage All Tasks",
    allTeams: "All Teams",
    teamPerformanceReports: "Team Performance Reports",
    ...
    demoMode: "Demo Mode",
    useAnyPassword: "Use any password (3+ characters)",
    managing: "Managing",
  ...
  ar: {
    ...
    noBioAvailable: "لا يوجد سيرة ذاتية متاحة",
    lead: "قائد",
    joined: "انضم",
    experience: "الخبرة",
    ...
    selectMemberToAdd: "اختر عضو لإضافته",
    allMembersAssigned: "تم تعيين جميع الأعضاء",
    assignmentInfo: "معلومات التعيين",
    selectAtLeastOneAssignee: "يرجى اختيار مكلف واحد على الأقل",
    singleAssigneeSelected: "مكلف واحد محدد",
    multipleAssigneesSelected: "{count} مكلفين محددين",
    clearAll: "مسح الكل",
    ...
    addRemoveMembers: "إضافة أو إزالة أعضاء",
    groupSettings: "إعدادات المجموعة",
    customizeGroup: "تخصيص إعدادات المجموعة",
    leaveGroup: "مغادرة المجموعة",
    leaveGroupWarning: "لن تتلقى رسائل المجموعة بعد الآن",
    sendMessage: "إرسال رسالة",
    inviteMembers: "دعوة أعضاء",
    groupDescription: "وصف المجموعة غير متاح",
    groupLeader: "قائد المجموعة",
    messages: "الرسائل",
    location: "الموقع",
    bio: "السيرة الذاتية",
    socialProfiles: "الملفات الشخصية الاجتماعية",
    performanceStats: "إحصائيات الأداء",
    teamsLed: "الفرق المقدمة",

    // Account Manager specific translations
    accountManagerDashboard: "لوحة تحكم مدير الحساب",
    adminDashboard: "لوحة تحكم المدير",
    teamPerformanceOverview: "نظرة عامة على أداء الفريق",
    manageTeamTasks: "إدارة مهام الفريق",
    manageAllTasks: "إدارة جميع المهام",
    allTeams: "جميع الفرق",
    teamPerformanceReports: "تقارير أداء الفريق",
    comprehensiveAnalytics: "التحليلات الشاملة",
    teamComparison: "مقارنة الفرق",
    enableComparison: "تفعيل المقارنة",
    disableComparison: "إلغاء المقارنة",
    compareWithTeam: "قارن مع الفريق",
    selectTeam: "اختر الفريق",
    teamPerformanceComparison: "مقارنة أداء الفرق",
    taskStatusDistribution: "توزيع حالة المهام",
    taskPriorityDistribution: "توزيع أولوية المهام",
    completionRate: "معدل الإنجاز",
    errorSavingTask: "خطأ في حفظ المهمة",
    ...
    useAnyPassword: "استخدم أي كلمة مرور (3+ أحرف)",
    managing: "إدارة",
    adminAccess: "تم منح صلاحيات المدير",
    readyToBoostTeamProductivity: "أنت جاهز لتعزيز إنتاجية الفريق",
  },
};
